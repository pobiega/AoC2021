...
public class Day08Tests
{
    ...
    public void ParseLine_Works()
    {
        ...
        var actual = Day_08.ParseLine(line);
    ...
    {
        var line = Day_08.ParseLine("acedgfb cdfbe gcdfa fbcad dab cefabd cdfgeb eafb cagedb ab | cdfeb fcadb cdfeb cdbaf");

        var segmentMap = Day_08.CalculateSegmentMap(line);
    ...
    public void CanDetermineUsageMap()
    {
        ...
        var actual = Day_08.CalculateUsageMap(line);
    ...
    public void CanTranslateOutput()
    {
        ...
        var actual = Day_08.TranslateOutput(line.OutputValues, segmentMap);
    ...
    public void CanConvertToDigit()
    {
        ...
        var actual = Day_08.ConvertToDigit("cdfeb", segmentMap);
